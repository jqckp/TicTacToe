public enum WinCondtion 
{
    ...
    LEFT_VERTICAL(Position.TOP_LEFT, Position.MIDDLE_LEFT, Position.MIDDLE_RIGHT),
    ...
    TOP_RIGHT_TO_BOTTOM_LEFT(Position.TOP_RIGHT, Position.TOP_CENTER, Position.BOTTOM_LEFT);
